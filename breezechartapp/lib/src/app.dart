...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListenableBuilder(
      ...
      builder: (BuildContext context, Widget? child) {
        return MaterialApp(
          title: 'BreezeChartApp',
          navigatorKey:
              globalNavigatorKey, //we can manage global ui using this key
  ...
  MaterialPageRoute Function(RouteSettings routeSettings)
      getMaterialPageRouteSettings() {
    return (RouteSettings routeSettings) {
      return MaterialPageRoute(
        settings: routeSettings,
        builder: (BuildContext context) =>
            _getPageRoutes(context, routeSettings),
      );
    };
  }
}
